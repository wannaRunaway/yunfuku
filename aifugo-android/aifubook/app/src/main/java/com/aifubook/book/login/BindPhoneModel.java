...
public class BindPhoneModel implements BaseModel {
     ...
     * @return 获得到订阅者
     */
    Subscription checkCode(Map<String, String> requestData, RxSubscriber<String> mRxSubscriber) {
        return Api.getInstance()
                .service
     ...
     *
     */
    Subscription bindMobile(Map<String, String> requestData, RxSubscriber<LoginHomePageBean> mRxSubscriber) {
        return Api.getInstance()
                .service
                .bindMobile(requestData)
