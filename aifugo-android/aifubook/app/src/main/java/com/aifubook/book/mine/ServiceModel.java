...
public class ServiceModel implements BaseModel {
     ...
     * @return 获得到订阅者
     */
    Subscription noticeList(Map<String, String> requestData, RxSubscriber<ServiceBean> mRxSubscriber) {
        return Api.getInstance()
                .service
                .noticeList(requestData)
                .compose(RxHelper.<ServiceBean>handleResult())
                .subscribe(mRxSubscriber);
    }
