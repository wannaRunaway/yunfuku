...
public class BaseViewHolder {
    ...
    public BaseViewHolder(Window window) {
        this.mWindow = window;
    ...
    public <T extends View> T getView(int viewId) {
        ...
        if (view == null) {
            if (mWindow != null) {
                view = mWindow.findViewById(viewId);
            } else if (mView != null) {
    ...
    public BaseViewHolder setEnabled(@IdRes int viewId, boolean enabled) {
    ...
    public BaseViewHolder setText(@IdRes int viewId, int strId) {
        TextView view = getView(viewId);
        view.setText(strId);
        return this;
    }
    ...
    public void setOnClickListener(View.OnClickListener listener, @IdRes int... viewIds) {
        for (int viewId : viewIds) {
            View view = getView(viewId);
            view.setOnClickListener(listener);
        }
    ...
    public RecyclerView setRecyclerViewAdapter(int viewId, RecyclerView.Adapter adapter) {
        RecyclerView view = getView(viewId);
        view.setAdapter(adapter);
        return view;
    }

    public RecyclerView setRecyclerViewLayoutManager(int viewId, RecyclerView.LayoutManager layoutManager) {
        RecyclerView view = getView(viewId);
    ...
    public CheckBox getChecked(@IdRes int viewId) {
        return getView(viewId);
    }

//    public BaseViewHolder setTextMoney(int viewId, float money) {
//        String amount = "¥" + Float.valueOf(TimeUtil.decima2Format.format(money));
//        TextView view = getView(viewId);
//        SpannableStringBuilder builder = new SpannableStringBuilder(amount);
//        builder.setSpan(new AbsoluteSizeSpan((int) (view.getTextSize() - 10)), amount.indexOf("¥"), amount.indexOf("¥") + 1
//                , Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//        builder.setSpan(new AbsoluteSizeSpan((int) (view.getTextSize() - 10)), amount.indexOf("."), amount.length()
//                , Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//        view.setText(builder);
//        return this;
//    }

    public BaseViewHolder setHttpText(int viewId, String text) {
        TextView view = getView(viewId);
        view.setText(Html.fromHtml(text));
        return this;
    }

    public BaseViewHolder setRecyclerViewNestedScrollingEnabled(int viewId, boolean enabled) {
        RecyclerView view = getView(viewId);
