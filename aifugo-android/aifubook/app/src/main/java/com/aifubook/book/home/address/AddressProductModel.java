...
public class AddressProductModel implements BaseModel {
     ...
     * @return 获得到订阅者
     */
    Subscription findShops(Map<String, Object> requestData, RxSubscriber<List<NearShopBean>> mRxSubscriber) {
        return Api.getInstance()
                .service
                .findShops(requestData)
                .compose(RxHelper.<List<NearShopBean>>handleResult())
