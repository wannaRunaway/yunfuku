...
import com.jiarui.base.progress.materialprogressbar.internal.ObjectAnimatorCompat;
...
class Animators {
    ...
    public static Animator createIndeterminate(Object target) {
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator trimPathStartAnimator = ObjectAnimator.ofFloat(target, "trimPathStart", 0,
                0.75f);
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator trimPathEndAnimator = ObjectAnimator.ofFloat(target, "trimPathEnd", 0,
                0.75f);
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator trimPathOffsetAnimator = ObjectAnimator.ofFloat(target, "trimPathOffset", 0,
                0.25f);
    ...
    public static Animator createIndeterminateRotation(Object target) {
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator rotationAnimator = ObjectAnimator.ofFloat(target, "rotation", 0, 720);
