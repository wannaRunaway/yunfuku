...
import com.jiarui.base.ms.banner.listener.OnBannerClickListener;
import com.jiarui.base.ms.banner.view.ArcShapeView;
import com.jiarui.base.ms.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public Banner setPagerMargin(int margin){
        if(viewPager!=null) {
    ...
    public void setAspectRatio(float ratio){
        viewPager.setAspectRatio(ratio);
    }
