...
/**
 * des:处理服务器数据的缓存 Created by xsf on 2016.09.11:01
 */
// ################################使用例子#############################
/*
 ...
 * 
 * RxCache.load(context,cacheKey,1000*60*30,fromNetwork,false) .subscribe(new
 * RxSubscribe<LoginData>(context, "登录中...") {
 * 
 * @Override protected void _onNext(LoginData data) {
 * showToast(R.string.login_success); //TODO login success }
 * 
 * @Override protected void _onError(String message) { showToast(message); } });
 */
...
public class RxCache {
	 ...
	 * @return
	 */
	public static <T> Observable<T> load(final Context context, final String cacheKey, final int expireTime,
