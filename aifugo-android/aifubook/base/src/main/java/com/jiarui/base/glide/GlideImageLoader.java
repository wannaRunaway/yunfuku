...
import com.jiarui.base.glide.progress.OnGlideImageViewListener;
import com.jiarui.base.glide.progress.OnProgressListener;
import com.jiarui.base.glide.progress.ProgressManager;
import com.jiarui.base.glide.transformation.GlideCircleTransformation;
...
public class GlideImageLoader {
    ...
    public void setPicScaleLoad(String url, RequestOptions options,final ImageView imageView){
        if (url == null || getContext() == null) return;
        requestScaleBuilder(url, options,imageView).into(getImageView());
    }

    public RequestBuilder<Drawable> requestScaleBuilder(Object obj, RequestOptions options,final ImageView imageView) {
        ...
        return Glide.with(getContext())
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                      ...
                      //  int vh = (int) ((float)vw/(float) 1.42);
                        int vh = (int) ((float)vw/(float) 1.42);
    ...
    public RequestOptions requestOptions(int placeholderResId, int errorResId) {
        return new RequestOptions()
                ...
                .error(errorResId).skipMemoryCache(true).dontAnimate().diskCacheStrategy(DiskCacheStrategy.ALL);//磁盘缓存
    }
