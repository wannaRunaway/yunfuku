...
public class ScannerFrameView extends View {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.zxing_ScannerFrameView);

        this.isFrameLineVisible = typedArray.getBoolean(R.styleable.zxing_ScannerFrameView_zxing_frameLine_visible, true);
        this.mFrameLineWidth = typedArray.getDimensionPixelSize(R.styleable.zxing_ScannerFrameView_zxing_frameLine_width, (int) (density));
        this.mFrameLineColor = typedArray.getColor(R.styleable.zxing_ScannerFrameView_zxing_frameLine_color, Color.WHITE);

        this.mFrameWidthRatio = typedArray.getFloat(R.styleable.zxing_ScannerFrameView_zxing_frame_widthRatio, 0);
        if (mFrameWidthRatio > 1) {
            mFrameWidthRatio = 1;
        }
        this.mFrameHeightRatio = typedArray.getFloat(R.styleable.zxing_ScannerFrameView_zxing_frame_heightRatio, 0);
        if (mFrameHeightRatio > 1) {
            mFrameHeightRatio = 1;
        }
        this.mFrameWHRatio = typedArray.getFloat(R.styleable.zxing_ScannerFrameView_zxing_frame_whRatio, 0);

        this.isFrameCornerVisible = typedArray.getBoolean(R.styleable.zxing_ScannerFrameView_zxing_frameCorner_visible, true);
        this.mFrameCornerLength = typedArray.getDimensionPixelSize(R.styleable.zxing_ScannerFrameView_zxing_frameCorner_length, 0);
        if (mFrameCornerLength <= 0) {
            this.isMeasureFrameCornerLengthByRatio = true;
            this.mFrameCornerLengthRatio = typedArray.getFloat(R.styleable.zxing_ScannerFrameView_zxing_frameCorner_lengthRatio, 0.1F);
        }
        this.mFrameCornerWidth = typedArray.getDimensionPixelSize(R.styleable.zxing_ScannerFrameView_zxing_frameCorner_width, (int) (3 * density));
        this.mFrameCornerColor = typedArray.getColor(R.styleable.zxing_ScannerFrameView_zxing_frameCorner_color, Color.BLUE);

        this.isScanLineVisible = typedArray.getBoolean(R.styleable.zxing_ScannerFrameView_zxing_scanLine_visible, true);
        this.mScanLineDirection = typedArray.getInt(R.styleable.zxing_ScannerFrameView_zxing_scanLine_direction, DIRECTION_BOTTOM);
        this.mScanLineLengthPadding = typedArray.getDimensionPixelSize(R.styleable.zxing_ScannerFrameView_zxing_scanLine_lengthPadding, -1);
        if (mScanLineLengthPadding < 0) {
            this.isMeasureScanLineLengthByRatio = true;
            this.mScanLineLengthRatio = typedArray.getFloat(R.styleable.zxing_ScannerFrameView_zxing_scanLine_lengthRatio, 0.98F);
        }
        this.mScanLineWidth = typedArray.getDimensionPixelSize(R.styleable.zxing_ScannerFrameView_zxing_scanLine_width, (int) (2 * density));
        this.mScanLineColor = typedArray.getColor(R.styleable.zxing_ScannerFrameView_zxing_scanLine_color, Color.BLUE);
        this.mScanCycle = typedArray.getInt(R.styleable.zxing_ScannerFrameView_zxing_scan_cycle, 1500);
        typedArray.recycle();
    }
