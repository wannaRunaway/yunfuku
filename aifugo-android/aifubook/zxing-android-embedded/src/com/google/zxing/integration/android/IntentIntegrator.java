...
public class IntentIntegrator {
    ...
    public static String BAR_COLOR="bar_color";
    public static String APP_TYPE="app_type";
    public static String APP_TYPE_WANSE="app_type_wanse";
    ...
    public Intent createScanIntent() {
        ...
        intentScan.putExtra(BAR_COLOR,getBarColor());
        intentScan.putExtra(APP_TYPE,getAppType());
